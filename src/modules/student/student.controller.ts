...
import { DeleteStudentPolicyHandler } from 'src/common/policies/delete.policy';
...
export class StudentController {
    ...
    @CheckPolicies(new CreateStudentPolicyHandler())
    @Post()
    ...
    @CheckPolicies(new DeleteStudentPolicyHandler())
    @Delete(':id')
